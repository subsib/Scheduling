	...
	qui prendrait du temps, mettant en péril la sécurité des passagers.
	...
	\begin{enumerate}
		...
		ils sont difficiles d'accès ou à recharger.
		\item Sur de grosses installations, comme des voitures ou un avion, cela peut représenter 
