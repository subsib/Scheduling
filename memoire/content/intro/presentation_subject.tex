	...
	Le secteur des appareils à équipement informatisé est en plein essor aujourd'hui. De nombreux systèmes de monitoring, tracking et autres 
	voient le jour et sont développés pour offrir des services qui 
	étaient impensables il y a peu.
	Le monde du système embarqué est très divers. En effet, 
	tous n'ont pas les mêmes contraintes, et parmi eux se trouve
	une proportion de systèmes temps réel qui nécessitent des ordonnanceurs adaptés. 
