...
\todo{ajouter surcout dans le glossaire}
	...
	de surcoût avec plus de cœurs. Une des hypothèses à vérifier peut-être de vérifier si certains systèmes 
	perdent en pratique leur faisabilité en passant de 2 à 4 cœurs, par exemple.
	...
	Dans la famille des ordonnanceurs globaux se trouve également \textbf{Global-FTP}, 
	...
	\textbf{Global-ED}F peut être considéré comme "vertical" là où UEDF serait "horizontal", et ce faisant, 
