\section{Choix de l'ordonnanceur}
	...
	Aussi nos questions restaient sans réponses, ce qui aurait pu permettre une implémentation 
	...
	qui a fixé le choix. Par conséquent, c'est \textbf{UEDF} qui a été sélectionné, car il respectait 
	les promesses énoncées auparavant en plus d'être très bien documenté, et nous pouvions 
	poser nos questions directement à l'un de ses créateurs. Néanmoins, ses paramètres sont moins idéaux, 
...
\section{Difficultés liées à l'implémentation}
	...
	\subsubsection{Utilisation instantanée et correction}
