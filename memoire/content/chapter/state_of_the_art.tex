	...
	où la priorité $p$ de la tâche $\tau_i$ est plus élevée si son échéance est plus proche.
	Pour $tau_{1} : d(t) = a$ et $tau_{2} : d(t) = b$, si $a < b$, alors $p(\tau_1) > p(\tau_2)$.\newline
	...
	L'algorithme ne permet pas de prévoir, aussi il n'est pas optimal, et dans le cas périodique, 
