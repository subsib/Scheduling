...
\begin{flushleft}
	...
	\begin{tabular}{l@{\hspace*{3em}}r}
		Promoteur : \large Pr. \textbf{Joël Goossens} & \large Mémoire présenté en vue\\
		\normalsize Expert externe : \large \textbf{Paul Rodriguez} & \hfill{}\large de l'obtention du diplôme de Master \\
		 & \large en Sciences informatiques\\
	\end{tabular}
...
\vfill\clearpage
	...
	\input{content/chapter/implementation2}	
