...
montre que d'autres facteurs devraient être pris en considération.\\
...
le problème ne se rencontre pas. Cela pourrait donner 
un avantage à l'algorithme \textit{PFair} ou diriger vers d'autres types de solutions.
...
Ce n'est pas à proprement parler un algorithme dont le but est qu'il soit appliqué, 
il est décrit dans la littérature comme un ordonnanceur idéal permettant 
de prouver des propriétés importantes pour le domaine. 
...
de nombreuses propositions d'algorithmes, comme les classiques \textit{PF}, \textit{PD}, \textit{PD²}, \textit{ER}, 
...
\begin{figure}[ht]
	\caption{Généalogie des approches P-Fair, issu de l'article de Müller et Werner\cite{muller_genealogy_2011}}
...
Nous invitons le lecteur à prendre connaissance de cet article 
extrêmement documenté.\\

De la lecture de ces articles, il ressort qu'une partie non négligeable d'entre eux 
est de parution récente, ce qui montre l'intérêt scientifique 
actuel pour ce type d'algorithmes. 
