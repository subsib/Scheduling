...
réduction de consommation énergétique ou en amélioration de l'efficacité.\\
...
Depuis la preuve qu'aucun ordonnanceur multiprocesseur optimal n'existe pour toutes les classes 
de tâches,
[Hong and Leung \cite{hong_-line_1988}, 1988] plusieurs candidats 
ordonnanceurs avec des propriétés différentes ont été proposés. 
Ils sont cependant assez peu utilisés actuellement dans l'industrie.\\

On peut raisonnablement imaginer que la situation évolue dans les prochaines années. 
En effet, les systèmes embarqués vont également nécessiter de la puissance de calcul et
de l'efficacité. 
Il est vrai que les contraintes de partage de ressources se posent différemment 
dans le cas parallélisé, 
avec plus de complexité mais cela pourrait en contrepartie apporter 
...
par un ordonnanceur partitionné. %TODO cite Static-Priority Periodic Scheduling on Multiprocessor Mark Moir
...
Par ailleurs, des études ont montré que les ordonnanceurs globaux basés sur \textbf{RM} et \textbf{DM} 
tendaient à avoir une utilisation plus faible que les ordonnanceurs partitionnés. 
