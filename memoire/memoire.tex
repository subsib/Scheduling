...
\vfill{}
\includegraphics{"img/sceauquadri"}
\vfill{}
\begin{flushright}{\large \textbf{Promoteur : Joël Goossens}}\hfill{}{\large Thesis submitted for the}\\
{\large Prof. Prénom Nom}\hfill{}{\large Master's degree}\\
\hfill{}{\large in Computer Science}\end{flushright}{\large\par}
