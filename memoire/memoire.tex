...
\end{center}
Notons également que pour $n \rightarrow \infty$, $\Sigma_{i=1}^{m}\frac{C_i}{T_i} \leq m(2^{\frac{1}{m}}-1) \rightarrow \ln(2) \approx 0.69$.
...
à échéance contrainte\ref{echeancecontrainte}. Les priorités sont fixes, au niveau des tâches.
...
\cite{ndoye}
\textbf{E}arliest \textbf{D}eadline \textbf{F}irst (EDF)
