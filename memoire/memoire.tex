...
%todo peut-être parler du fait que si des tâches doivent communiquer entre elles, en plus, 
%todo le problème du partitionnement peut devenir un peu plus compliqué
%todo y a pas des algos génétiques ?!
...
La notion de P-Fairness est très souvent utilisée dans la littérature et d'elle dérive de 
nombreuses propositions d'algorithmes, comme pour DP-Fair \cite{levin_dp-fair:_2010}, 
%todo add refs 
