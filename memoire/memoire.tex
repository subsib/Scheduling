...
\subsection{PFair}
\textit{PFair} n'est pas un algorithme applicable, il est décrit dans la littérature comme 
un ordonnanceur idéal permettant de prouver des propriétés importantes pour le domaine. 
