...
\begin{document}
	...
	%todo Parler de l'autonomie, du poids, du prix des composants
	%durant le passé, les lois de Moore %todo add ref
	%se sont vérifiées car il était encore possible de miniaturiser les composants, 
	%ce qui faisait gagner en efficacité d'autant. Cela n'est actuellement plus le cas, 
	%les composants étant déjà largement miniaturisés, de nouvelles miniaturisations 
	%n'entraineraient plus de gain. 
	...
	%todo pas sûre de la définition...
	...
	Malheureusement, ce résultat n'est pas valable dans le cas multiprocesseur \cite{dertouzos_multiprocessor_1989}.\medskip
	...
	%todo ah bon? La propriété dans l'article de 1978 n'est pas aussi forte --> check it
	...
	\begin{mydef} %TODO expliquer la syntaxe
