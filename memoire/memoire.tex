...
Durant les 40 dernières années, ce sont principalement les progrès
technologiques qui ont permis d'améliorer les vitesses d'exécution, 
entre autres grâce à la miniaturisation des composants.

Cela fait cependant plusieurs années que la croissance n'est plus 
principalement due à des améliorations physiques des composants en tant que tels. 
